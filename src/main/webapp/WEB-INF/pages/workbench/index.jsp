...
<script type="text/javascript">
	...
	$(function(){
		...
		window.open("${pageContext.request.contextPath}/workbench/main/toMainIndex.action","workareaFrame");
		...
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" id="closeMyInfo">关闭</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li id="showMyInfo"><a href="javascript:void(0)" data-toggle="modal" ><span class="glyphicon glyphicon-file"></span> 我的资料</a></li>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<li class="liClass"><a href="${pageContext.request.contextPath}/workbench/main/toIndex.action" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
				...
				<li class="liClass"><a href="${pageContext.request.contextPath}/workbench/activity/toIndex.action" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
